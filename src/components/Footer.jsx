...
export default function Footer() {
    return (
        <footer className="bg-footer text-white py-8 sm:py-12 lg:py-16">

            <div className="w-screen relative left-1/2 right-1/2 -mx-[50vw] -mt-16 bg-footer py-6 sm:py-10 border-b border-primary overflow-hidden">                {/* Gradient edges (premium look) */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 pt-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-300">
                            <li>
                                <Link to="/offers-promotions" className="hover:text-white">
                                    Offers & Promotions
                                </Link>
                            </li>
                            <li>
